const data = {
  ...
  "trivia": [
    ...
    [("Who has hiked the most in the group?"), ("sakib")],
    ...
    [("He shared with us his amazing score on Duolingo."), ("reza")],
    [("He shared recordings of his full workout routine."), ("reza")],
    ...
    [("This guy was an active member, not a board member, of Islamic Cultural Club in AUS when Abid was the president."), ("huzaifa")],
    ...
    [("This legend once suggested a random restaurant from Zomato and we had the most awkward experience there. We met the restaurant owner's wife, for some reason."), ("sakib")],
  ],
};
